<template>
  <div style="background-color: gainsboro">
    <div style="background-color: white; height: 70px;">
      ...
      <span style="margin-top: 10px; height: 44px; line-height: 44px; font-size: 24px; float: left">发起通报</span>
    </div>
    <div style="clear: both"></div>

    <div style="display: flex; flex-direction: row; margin-top: 3px">
      <div style="width: 60%; height: 100%; background-color: palegoldenrod">
        <el-form :model="ruleForm" :rules="rules" ref="ruleForm" label-width="90px" style="padding-top: 20px; width: 1050px" class="demo-ruleForm">

          <el-form-item label="通报标题" prop="name">
            <el-input v-model="ruleForm.name" placeholder="请输入通报标题"></el-input>
          </el-form-item>

          <el-form-item label="通报内容" prop="desc">
            <el-input type="textarea" v-model="ruleForm.desc" placeholder="请输入通报内容"></el-input>
          </el-form-item>
          ...
          <div style="float: left">
            <el-form-item label="信息类别" prop="region">
          ...
          <div style="float: left">
            <el-form-item label="值班员" prop="name">
              <el-input v-model="ruleForm.name" placeholder="请输入值班员"></el-input>
            </el-form-item>
          </div>
          <div style="clear: both"></div>
          ...
          <el-form-item label="核查人员" prop="name">
            <el-upload
              ...
              :file-list="List"
              list-type="picture">
              <el-button size="small" type="primary">添加人员</el-button>
              <el-button size="small" type="primary">从模版中导入</el-button>
            </el-upload>
          </el-form-item>
          <el-form-item label="信息附件" prop="name">
            <el-upload
              class="upload-demo"
              style="width: 370px"
              action="https://jsonplaceholder.typicode.com/posts/"
          ...
          <el-form-item label="审批流程" prop="desc">
            <el-steps direction="vertical" :active="2">
              <el-step title="指挥长" icon="el-icon-picture" description="请添加审批人员">
              </el-step>
              <el-step title="抄送人员" icon="el-icon-picture" description="抄送2人">
              </el-step>
            </el-steps>
          </el-form-item>
          <el-form-item label="通报单位" prop="name">
            <el-tag
              :key="tag1"
