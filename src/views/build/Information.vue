<template>
  <div style="background-color: gainsboro">
    <div style="background-color: white; height: 70px;">
      ...
      <span style="margin-top: 10px; height: 44px; line-height: 44px; font-size: 24px; float: left">发起信息</span>
    </div>
    <div style="clear: both"></div>

    <div style="display: flex; flex-direction: row; margin-top: 3px">
      <div style="width: 60%; height: 100%; background-color: pink">
        <el-form :model="ruleForm" :rules="rules" ref="ruleForm" label-width="90px" style="padding-top: 20px; width: 1050px" class="demo-ruleForm">
          ...
          <el-form-item label="审批流程" prop="desc">
            <el-steps direction="vertical" :active="2">
              <el-step title="审批人员" icon="el-icon-picture" description="请添加审批人员">
              </el-step>
              <el-step title="抄送人员" icon="el-icon-picture" description="抄送2人">
              </el-step>
            </el-steps>
          </el-form-item>
          <el-form-item label="审批事由" prop="desc">
            <el-input type="textarea" v-model="ruleForm.desc" placeholder="请输入审批事由"></el-input>
          </el-form-item>
          <el-form-item label="流转流程" prop="name">
            <el-tag
              :key="tag1"
